...
const ProcessPage = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      prompt: "This website was created using Manus AI with a comprehensive set of prompts for design, development, and content creation. The full prompt list is available separately upon request.",
      result: "A modern, responsive portfolio website featuring minimalist design, aesthetic green and blue color scheme, smooth animations, and professional typography. The site showcases the AI story project across three main sections: the story itself, the creative process, and information about the creator.",
